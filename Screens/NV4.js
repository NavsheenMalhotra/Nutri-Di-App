...
export default class NV4 extends React.Component {
  render() {
    return (
      <SafeAreaProvider>
        ...
        PLAN 4
          ...
          <Image
            source={require('../assets/non-veg4.jpg')}
            style={{ width: RFValue(340), height: RFValue(200), marginTop: RFValue(80), alignContent: 'center', alignItems: 'center', alignSelf: 'center' }}
          />
