...
export default class V2 extends React.Component {
  goToV3=()=>{
    ...
    return (
      <SafeAreaProvider>
        ...
        PLAN 2
          ...
          <Image
            source={require('../assets/vp2.jpg')}
            style={{ width: RFValue(330), height: RFValue(350), marginTop: RFValue(80), alignContent: 'center', alignItems: 'center', alignSelf: 'center' }}
          />
          <TouchableOpacity 
          onPress={()=>{
            this.goToV3()
