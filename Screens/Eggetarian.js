...
export default class Eggetarians extends React.Component {
  goToE2=()=>{
    this.props.navigation.navigate('E2')
  }
  render() {
    return (
      <SafeAreaProvider>
        ...
        PLAN 1
          ...
          <Image
            source={require('../assets/eggetarian1.jpg')}
            style={{ width: RFValue(320), height: RFValue(325), marginTop: RFValue(80), alignContent: 'center', alignItems: 'center', alignSelf: 'center' }}
          />
          <TouchableOpacity 
          onPress={()=>{
            this.goToE2()
