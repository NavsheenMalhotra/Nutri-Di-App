...
export default class E3 extends React.Component {
  goToE4=()=>{
    this.props.navigation.navigate('E4')
  }
  render() {
    return (
      <SafeAreaProvider>
        ...
        PLAN 3
          ...
          <Image
            source={require('../assets/eggetarian3.jpg')}
            style={{ width: RFValue(310), height: RFValue(330), marginTop: RFValue(80), alignContent: 'center', alignItems: 'center', alignSelf: 'center' }}
          />
          <TouchableOpacity 
          onPress={()=>{
            this.goToE4()
