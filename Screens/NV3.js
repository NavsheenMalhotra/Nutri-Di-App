...
export default class NV3 extends React.Component {
  goToNV4=()=>{
    this.props.navigation.navigate('NV4')
  }
  render() {
    return (
      <SafeAreaProvider>
        ...
        PLAN 3
          ...
          <Image
            source={require('../assets/non-veg3.jpg')}
            style={{ width: RFValue(330), height: RFValue(260), marginTop: RFValue(80), alignContent: 'center', alignItems: 'center', alignSelf: 'center' }}
          />
          <TouchableOpacity 
          onPress={()=>{
            this.goToNV4()
